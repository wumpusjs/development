...
> implements IModule<InitialArguments, StartArguments, StopArguments>
{
	...
	public init(..._args: InitialArguments): void | Promise<void> {}
	public start(..._args: StartArguments): void | Promise<void> {}
	public stop(..._args: StopArguments): void | Promise<void> {}
}
